...
__all__ = ["SessionStatusDetail", "Type", "UnionMember1", "UnionMember3", "UnionMember3PendingCall"]
...
SessionStatusDetail: TypeAlias = Union[Type, UnionMember1, Type, UnionMember3]
