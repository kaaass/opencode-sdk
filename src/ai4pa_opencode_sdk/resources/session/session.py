...
from ...types import (
    ...
    session_get_message_diff_params,
...
from ...types.session_get_todos_response import SessionGetTodosResponse
...
from ...types.session_get_message_diff_response import SessionGetMessageDiffResponse
...
class SessionResource(SyncAPIResource):
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    session_abort_params.SessionAbortParams,
                ),
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    session_get_children_params.SessionGetChildrenParams,
                ),
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    session_get_message_diff_params.SessionGetMessageDiffParams,
                ),
            ),
            cast_to=SessionGetMessageDiffResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    session_get_todos_params.SessionGetTodosParams,
                ),
            ),
            cast_to=SessionGetTodosResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    session_list_artifacts_params.SessionListArtifactsParams,
                ),
            ),
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    session_respond_to_permission_params.SessionRespondToPermissionParams,
                ),
            ),
    ...
    def submit_tool_results(
        ...
        *,
        ...
        """
        Submit results for client tools that paused the inference loop, and optionally
        resume the loop.
...
class SessionResourceWithRawResponse:
    def __init__(self, session: SessionResource) -> None:
        ...
        self.get_message_diff = to_raw_response_wrapper(
            session.get_message_diff,
        )
        self.get_todos = to_raw_response_wrapper(
            session.get_todos,
        )
    ...
    def status(self) -> StatusResourceWithRawResponse:
        return StatusResourceWithRawResponse(self._session.status)
...
class AsyncSessionResourceWithRawResponse:
    def __init__(self, session: AsyncSessionResource) -> None:
        ...
        self.get_message_diff = async_to_raw_response_wrapper(
            session.get_message_diff,
        )
        self.get_todos = async_to_raw_response_wrapper(
            session.get_todos,
        )
    ...
    def status(self) -> AsyncStatusResourceWithRawResponse:
        return AsyncStatusResourceWithRawResponse(self._session.status)
...
class SessionResourceWithStreamingResponse:
    def __init__(self, session: SessionResource) -> None:
        ...
        self.get_message_diff = to_streamed_response_wrapper(
            session.get_message_diff,
        )
        self.get_todos = to_streamed_response_wrapper(
            session.get_todos,
        )
    ...
    def status(self) -> StatusResourceWithStreamingResponse:
        return StatusResourceWithStreamingResponse(self._session.status)
...
class AsyncSessionResourceWithStreamingResponse:
    def __init__(self, session: AsyncSessionResource) -> None:
        ...
        self.get_message_diff = async_to_streamed_response_wrapper(
            session.get_message_diff,
        )
        self.get_todos = async_to_streamed_response_wrapper(
            session.get_todos,
        )
    ...
    def status(self) -> AsyncStatusResourceWithStreamingResponse:
        return AsyncStatusResourceWithStreamingResponse(self._session.status)
