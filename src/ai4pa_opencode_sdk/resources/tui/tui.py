...
class TuiResource(SyncAPIResource):
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_append_prompt_params.TuiAppendPromptParams,
                ),
            ),
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_clear_prompt_params.TuiClearPromptParams,
                ),
            ),
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_execute_command_params.TuiExecuteCommandParams,
                ),
            ),
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_open_help_params.TuiOpenHelpParams,
                ),
            ),
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_open_models_params.TuiOpenModelsParams,
                ),
            ),
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_open_sessions_params.TuiOpenSessionsParams,
                ),
            ),
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_open_themes_params.TuiOpenThemesParams,
                ),
            ),
    ...
    def publish(
        self,
        *,
        properties: tui_publish_params.EventPromptAppendProperties,
    ...
    def publish(
        self,
        *,
        properties: tui_publish_params.EventCommandExecuteProperties,
    ...
    def publish(
        self,
        *,
        properties: tui_publish_params.EventToastShowProperties,
    ...
    def publish(
        self,
        *,
        properties: tui_publish_params.EventSessionSelectProperties,
    ...
    def publish(
        ...
        *,
        properties: tui_publish_params.EventPromptAppendProperties
        | tui_publish_params.EventCommandExecuteProperties
        | tui_publish_params.EventToastShowProperties
        | tui_publish_params.EventSessionSelectProperties,
        type: Literal["tui.prompt.append"]
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                tui_publish_params.TuiPublishParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_select_session_params.TuiSelectSessionParams,
                ),
            ),
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    tui_submit_prompt_params.TuiSubmitPromptParams,
                ),
            ),
