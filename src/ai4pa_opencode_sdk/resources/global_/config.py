...
class ConfigResource(SyncAPIResource):
    ...
    def update_config(
        ...
        *,
        ...
        agent: config_update_config_params.Agent | Omit = omit,
        ...
        command: Dict[str, config_update_config_params.Command] | Omit = omit,
        compaction: config_update_config_params.Compaction | Omit = omit,
