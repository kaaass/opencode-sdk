...
from ...types.provider import custom_list_params, custom_create_params, custom_delete_params
from ...types.provider.custom_list_response import CustomListResponse
from ...types.provider.custom_create_response import CustomCreateResponse
from ...types.provider.custom_delete_response import CustomDeleteResponse
...
class CustomResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            path_template("/provider/custom/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
