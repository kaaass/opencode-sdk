...
class TestClientConnection:
    ...
    def test_method_list(self, client: OpencodeSDK) -> None:
        client_connection = client.client_connection.list()
        assert_matches_type(ClientConnectionListResponse, client_connection, path=["response"])
    ...
    def test_raw_response_list(self, client: OpencodeSDK) -> None:
        response = client.client_connection.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: OpencodeSDK) -> None:
        with client.client_connection.with_streaming_response.list() as response:
...
class TestAsyncClientConnection:
    ...
    async def test_method_list(self, async_client: AsyncOpencodeSDK) -> None:
        client_connection = await async_client.client_connection.list()
        assert_matches_type(ClientConnectionListResponse, client_connection, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOpencodeSDK) -> None:
        response = await async_client.client_connection.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncOpencodeSDK) -> None:
        async with async_client.client_connection.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
