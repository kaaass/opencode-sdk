...
class TestExperimental:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_list_sessions(self, client: OpencodeSDK) -> None:
        experimental = client.experimental.list_sessions()
        assert_matches_type(ExperimentalListSessionsResponse, experimental, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_list_sessions_with_all_params(self, client: OpencodeSDK) -> None:
        experimental = client.experimental.list_sessions(
            archived=True,
            cursor=0,
            directory="directory",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_list_sessions(self, client: OpencodeSDK) -> None:
        response = client.experimental.with_raw_response.list_sessions()
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_list_sessions(self, client: OpencodeSDK) -> None:
        with client.experimental.with_streaming_response.list_sessions() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncExperimental:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_sessions(self, async_client: AsyncOpencodeSDK) -> None:
        experimental = await async_client.experimental.list_sessions()
        assert_matches_type(ExperimentalListSessionsResponse, experimental, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_sessions_with_all_params(self, async_client: AsyncOpencodeSDK) -> None:
        experimental = await async_client.experimental.list_sessions(
            archived=True,
            cursor=0,
            directory="directory",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_list_sessions(self, async_client: AsyncOpencodeSDK) -> None:
        response = await async_client.experimental.with_raw_response.list_sessions()
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_list_sessions(self, async_client: AsyncOpencodeSDK) -> None:
        async with async_client.experimental.with_streaming_response.list_sessions() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
